 ...
 * Copyright (c) 2024 ; Not Licensed */
!(function () {
	'use strict';
	function checkType(t) {
		// kiểm tra điều kiện rồi set lại chính function checkType thành cái khác rồi return kết quả của cái vừa thay đổi
		return (
			(checkType =
		...
		for (var r = 0; r < n.length; r++) {
			...
			(i.enumerable = i.enumerable || false),
				...
				Object.defineProperty(
					...
					(a = void 0),
					(a = (function (t, n) {
						if ('object' !== checkType(t) || null === t) return t;
						var r = t[Symbol.toPrimitive];
						if (void 0 !== r) {
							var i = r.call(t, n || 'default');
							if ('object' !== checkType(i)) return i;
							throw new TypeError('@@toPrimitive must return a primitive value.');
						}
						return ('string' === n ? String : Number)(t);
					})(o, 'string')),
					'symbol' === checkType(a) ? a : String(a)),
					i,
				);
		}
		var o, a;
	...
	// Bien DS la bien global cua iframe, da khai bao trong file html
	var DS_clone = DS,
		DS_clone_ = DS_clone._,
		DS_clonePubSub = DS_clone.pubSub,
		DS_cloneEvents = DS_clone.events,
		DS_cloneContants = DS_clone.constants,
		DS_cloneUtils = DS_clone.utils,
		DS_cloneTranslationStore = DS_clone.translationStore,
		c = [];
	var bienU = (function () {
			function e(t, n, l) {
				var s = this;
				!(function (e, t) {
					...
					(this.frame = t),
					(this.frame.blocked = false),
					(this.preso = l),
					this.setupControlOptions(),
					(this.layouts = {}),
					(this.dockedStates = {}),
					(this.dockSettings = {
						dockedState: DS_cloneContants.docked.NONE,
						width: 0,
					}),
					this.setLayout(this.frame.default_layout, DS_cloneContants.refs.FRAME),
					DS.flagManager.multiLangSupport && !DS_clone_.isEmpty(n) && this.setLocalizationData(n, true),
				...
				(this.rtl = 'rtl' === this.frame.textdirection),
					...
					DS_clone_.bindAll(this, 'onLayoutChanged'),
					DS_clonePubSub.on(DS_cloneEvents.controlLayout.CHANGED, this.onLayoutChanged),
					DS_clonePubSub.on(DS_cloneEvents.controlLayout.UPDATE, function (e, t, n) {
						(s.frame.controlLayouts[e] = n), s.setLayout(e, t);
					}),
					DS_clonePubSub.on(DS_cloneEvents.controlOptions.CHANGED, function (e) {
						var t = s.optionChangesRequireMenuRefresh(s.frame.controlOptions.menuOptions, e.menuOptions);
						(s.frame.controlOptions = e), s.setupControlOptions(), DS_clonePubSub.trigger(DS_cloneEvents.controlOptions.RESET), t && DS_clonePubSub.trigger(DS_cloneEvents.navData.REFRESH_VIEW);
					}),
					DS_clonePubSub.on(DS_cloneEvents.frame.FONT_SCALE, function (e) {
						(s.frame.fontscale = e), DS_clonePubSub.trigger(DS_cloneEvents.controlOptions.RESET);
					}),
					DS_clonePubSub.on(DS_cloneEvents.glossary.UPDATE, function (e) {
						(s.frame.glossaryData = e), DS_clonePubSub.trigger(DS_cloneEvents.glossary.REFRESH_VIEW);
					}),
					DS_clonePubSub.on(DS_cloneEvents.navData.UPDATE, function (e) {
						(s.frame.navData = e), DS_clonePubSub.trigger(DS_cloneEvents.navData.REFRESH_VIEW);
					}),
					DS_clonePubSub.on(DS_cloneEvents.resources.UPDATE, function (e) {
						(s.frame.resourceData.resources = e), DS_clonePubSub.trigger(DS_cloneEvents.resources.REFRESH_VIEW);
					}),
					DS_clonePubSub.on(DS_cloneEvents.resources.UPDATE_DESCRIPTION, function (e) {
						(s.frame.resourceData.description = e), DS_clonePubSub.trigger(DS_cloneEvents.resources.REFRESH_VIEW);
					}),
					DS_clonePubSub.on(DS_cloneEvents.layer.DIALOG_SHOWN, function (e) {
						var t = DS.windowManager.getCurrentWindow();
						DS_clonePubSub.trigger(DS_cloneEvents.frameModel.BLOCKED_CHANGED, t.frame.id, true, e);
					}),
					DS_clonePubSub.on(DS_cloneEvents.layer.DIALOG_HIDDEN, function () {
						var e = DS.windowManager.getCurrentWindow();
						DS_clonePubSub.trigger(DS_cloneEvents.frameModel.BLOCKED_CHANGED, e.frame.id, false);
					}),
					DS_clonePubSub.on(DS_cloneEvents.localization.LANGUAGE_UPDATED, function () {
						s.setLocalizationData(DS.localizationManager.getCurrentFrameData());
					}),
					DS_clonePubSub.on(DS_cloneEvents.localization.REVIEW_FRAME_UPDATED, function () {
			...
			return (
				...
				(u = [
					...
					},
					{
						...
						value: function () {
							var e = DS_cloneUtils.getPath(this.frame, 'navData.outline.links', []);
							this.traverseMenu(function (e) {
								e.displaytext = DS_cloneTranslationStore.getUpdatedTextData('menuItem', ''.concat(e.translationId, '-Name'), e.displaytext);
							}, e);
						},
					},
					{
						...
						value: function () {
							(this.frame.glossaryData || []).forEach(function (e) {
								...
								(e.title = DS_cloneTranslationStore.getUpdatedTextData('glossaryItem', ''.concat(t, '-Term'), e.title)),
									(e.content = DS_cloneTranslationStore.getUpdatedTextData('glossaryItem', ''.concat(t, '-Definition'), e.content));
							});
						},
					},
					{
						...
						value: function () {
							DS_cloneUtils.getPath(this.frame, 'resourceData.resources', []).forEach(function (e) {
								var t = e.translationId;
								e.title = DS_cloneTranslationStore.getUpdatedTextData('resourceItem', ''.concat(t, '-Title'), e.title);
							});
						},
					},
					{
						...
						value: function () {
							(this.frame.notesData || []).forEach(function (e) {
								var t = e.slideId,
									n = DS_clone_.last(t.split('.')),
									i = DS_cloneTranslationStore.getUpdatedTextData('slideNote', ''.concat(n, '-Note'));
					...
					},
					{
						...
						value: function () {
							this.updateMenuStrings(),
								...
								(this.title.text = DS_cloneTranslationStore.getUpdatedTextData('projectTitle', 'project-Title', this.title.text)),
					...
					},
					{
						...
						value: function () {
							DS_clonePubSub.trigger(DS_cloneEvents.strings.UPDATE_STRINGS),
								DS_clonePubSub.trigger(DS_cloneEvents.navData.REFRESH_VIEW),
								DS_clonePubSub.trigger(DS_cloneEvents.glossary.REFRESH_VIEW),
								DS_clonePubSub.trigger(DS_cloneEvents.resources.REFRESH_VIEW),
								DS_clonePubSub.trigger(DS_cloneEvents.transcript.REFRESH_VIEW),
								DS_clonePubSub.trigger(DS_cloneEvents.frame.REFLOW);
						},
					},
					{
					...
					},
					{
						...
						value: function (e) {
							return DS_cloneTranslationStore.getUpdatedTextData('frameLink', ''.concat(e, '-Link'), DS_cloneUtils.getPath(this.frame, 'controlStrings.'.concat(e), null));
						},
					},
					{
						key: 'getString',
					...
					},
					{
						...
						value: function (e, t, n) {
							t === DS_cloneContants.docked.NONE
								? ((this.dockedStates[e] = null), delete this.dockedStates[e])
								: (this.dockedStates[e] = {
										dockedState: t,
										width: n,
								  });
					...
					},
					{
						...
						value: function (e, t) {
							(this.currLayout = this.frame.layouts[e]),
								...
								DS_clonePubSub.trigger(DS_cloneEvents.frameModel.LAYOUT_CHANGED, this.currControlLayout, t);
						},
					},
					{
		...
		var bienF = bienU;
		// checkType2 giong het checkType
	function checkType2(e) {
		return (
			(checkType2 =
				'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
					? function (e) {
	...
	function bienP(e, t) {
		return (
				...
				if (null != n) {
					...
					try {
						if (((o = (n = n.call(e)).next), 0 === t)) {
							...
							s = false;
						} else for (; !(s = (r = o.call(n)).done) && (l.push(r.value), l.length !== t); s = true);
					} catch (e) {
						(c = true), (i = e);
					} finally {
						try {
			...
			(function (e, t) {
				if (!e) return;
				if ('string' == typeof e) return bienY(e, t);
				var n = Object.prototype.toString.call(e).slice(8, -1);
				'Object' === n && e.constructor && (n = e.constructor.name);
				if ('Map' === n || 'Set' === n) return Array.from(e);
				if ('Arguments' === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return bienY(e, t);
			})(e, t) ||
			(function () {
				throw new TypeError(
	...
	function bienY(arrayE, t) {
		(null == t || t > arrayE.length) && (t = arrayE.length);
		for (var n = 0, arrayR = new Array(t); n < t; n++) arrayR[n] = arrayE[n];
		// tra lai 1 bien giong het mang e
		return arrayR;
	}
	function b(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, bienV(r.key), r);
		}
	}
	function bienV(e) {
		var t = (function (e, s) {
			if ('object' !== checkType2(e) || null === e) return e;
			var n = e[Symbol.toPrimitive];
			if (void 0 !== n) {
				var r = n.call(e, s || 'default');
				if ('object' !== checkType2(r)) return r;
				throw new TypeError('@@toPrimitive must return a primitive value.');
			}
			return ('string' === s ? String : Number)(e);
		})(e, 'string');
		return 'symbol' === checkType2(t) ? t : String(t);
	}
	var g,
		DS_clone = DS,
		w = DS_clone._,
		S = DS_clone.scaler,
		k = DS_clone.detection,
		O = DS_clone.detection.orientation,
		E = DS_clone.utils,
		C = E.getPath,
		x = E.scaleVal,
		L = E.pxify,
		...
		T = P.addClass,
		j = P.removeClass,
		D = DS_clone.constants.refs.FRAME,
		...
		M = function (e, t, n) {
			B(e), (n = e.w > 0 ? n : 0), (e.y = e.top = 0), (e.x = e.left = t.l + n), e.update(true), (t.l = e.x + e.w);
		},
		H = function (e, t, n) {
			B(e), (n = e.w > 0 ? n : 0), (e.y = e.top = 0), (e.x = e.left = t.r - e.w - n), e.update(true), (t.r = e.x);
		},
		N = function (e, t, n) {
			B(e), (n = e.h > 0 ? n : 0), (e.x = e.left = 0), (e.y = e.top = t.t + n), e.update(true), (t.t = e.y + e.h);
		},
		F = function (e, t, n) {
			B(e), (n = e.h > 0 ? n : 0), (e.x = e.left = 0), (e.y = e.top = t.b - e.h - n), e.update(true), (t.b = e.y);
		},
		W = {
			l: M,
			r: H,
			...
			return (
				...
				(n = [
						...
						value: function (e) {
							if (this.hasInited) console.warn('has already initialized', this);
								...
								var n = this.ViewLogic,
									r = this.params;
								null == r && null != n ? (r = n) : null != n && (t = true),
									...
									(r = Object.assign(
										...
										r,
									)).calcTextSize && (r.noContent = false),
					...
					},
					{
						key: 'initVisibility',
						value: function (e) {
							false === e.visible && this.setVisibility(false);
						},
					},
					{
						key: 'initChildRefs',
						value: function () {
							...
							for (var e = this.el.querySelectorAll('[data-ref]'), t = 0; t < e.length; t++)
								this.children[e[t].dataset.ref] = {
									el: e[t],
								};
						},
					},
					...
					},
					{
						key: 'isBlocked',
						value: function () {
							if (k.theme.isClassic) return false;
						...
						value: function (e, t) {
							...
							return (
								'no-reflow' === this.visibility
									...
									: 'reflow' === this.visibility && ((this.el.style.display = e ? 'block' : 'none'), (r = true)),
					...
					},
					{
						key: 'endFloat',
						value: function () {
							this.floating && ((this.floating = false), this.shouldReparent && this.lastFloatParent.appendChild(this.el));
						},
					},
					{
						key: 'right',
	...
	(V.propFns = {
		...
		(V.prop = function (e, t, n) {
			...
			else if ('string' == typeof n && null != V.propFns[n])
		...
		Q = function (e) {
			...
			return (
				'string' === r
					...
					: console.warn('invalid view definition. '.concat(e, ' is a ').concat(checkType2(e))),
				{
					viewName: t,
					children: n,
				}
		...
		G = {
			...
			resetStates: function (e) {
				...
				w.forEach(t, function (e) {
					return e && e.setEnabled && e.setEnabled(true);
				});
			},
			updateVisibility: function (e, t) {
				...
				for (var r in e) {
					...
					if (null != i) i.setVisibility(e[r], true) && (n = true);
				}
				return n;
			},
			def: function (e, t, n) {
				...
				return (
					null == U[e]
						? ((U[e] = r),
						  ...
						  (z[e] = 0))
						: console.warn('views connot share the same name '.concat(e)),
					r
				);
			},
					...
					(this.nameSpaces[g] = this.nameSpaces[g] || {
						...
						updateTabIndex: function () {
							...
							this.topLevelElements.forEach(function (i) {
								var o = function (e, t) {
									t ? e.el.removeAttribute('aria-hidden') : e.el.setAttribute('aria-hidden', true);
								};
								t &&
							...
							if (null !== r) {
								...
								if (null != l) {
									if (((l.nameSpace = e), C(a, 'length') > 0)) {
										l.setChildNum(a.length), (l.hasChildren = true);
	...
	var ye,
			...
			(ye = {
						...
						l = function (e, n, r) {
							if (e === t) {
								var i = r ? r.getWndBlockerBackground() : '',
									a = G.getBlocker(e);
								null != a && (a.setBackgroundColor(i), a.setVisibility(n)), (o.tabReachable = !n), o.updateTabIndex(false, true);
							}
						};
					return (
						null == o &&
							...
							var t = (function () {
								...
								return (
									...
									_.each(G.getNamespace(Ve).topTabs.children, function (t) {
										_.each(_.filter(t.children, 'viewLogic.showing', true), function (t) {
				...
				setAllAccVisibility: function (e) {
					_.forEach(G.nameSpaces, function (t) {
						var n = t.wrapper;
						e ? n.el.removeAttribute('aria-hidden') : n.el.setAttribute('aria-hidden', true);
					});
				},
			}),
				Ke.on(Be, $e),
		...
		et = function () {
			(ye.hasData = true), Ke.trigger(_e, ye);
		},
		tt = DS,
		...
		ot = function (e, t) {
			return e.some(function (e) {
				var n = t[e.name];
				return null == n || ('outline' === e.name && n.enabled) || true === n;
			});
		};
	function at(e) {
		return (
	...
	G.def(ft, function () {
		...
		return {
			attrs: {
				id: ft,
				class: 'cs-base cs-'.concat(e.default_layout, ' fn-').concat(e.default_layout, ' cs-custom-theme'),
			},
			style: {
				fontSize: ''.concat(e.fontscale, '%'),
			},
			x: 0,
			y: 0,
			w: function () {
			...
			return (
				...
				(n = [
					...
					},
					{
						key: 'onBlur',
						value: function (e) {
							xt.takeFocusOff(), this.onHoverOut(e), (this.hasFocus = false);
						},
					},
					{
						...
						value: function (e) {
							...
							if (_t() && this.hasTooltip && (null == this.hideTooltipWhenOpen || !this.isOpen)) {
								...
								bt.setTooltipOn(
									...
									this.tooltipMoves && this.setForFollowMouse(),
									(this.tooltipOn = true);
							}
						},
					},
					{
						key: 'dismissTooltip',
						value: function () {
							bt.hideTooltip(this), this.tooltipMoves && this.stopFollowMouse(), (this.tooltipOn = false);
						},
					},
					{
						key: 'onHoverOut',
	...
	G.def(Ht, Nt, function () {
		...
		return {
			attrs: {
				id: Ht,
				class: 'cs-base cs-'.concat(e.frame.default_layout, ' fn-').concat(e.frame.default_layout),
			},
			w: '100%',
			h: '100%',
					...
					(n = [
						{
							...
							value: function (e) {
								e.hidden
									? (this.el.setAttribute('aria-hidden', true), this.el.setAttribute('tabindex', 0))
	...
	G.def(In, Cn, function (e) {
		...
		return {
			attrs: {
				id: In,
				class: 'window-slide '.concat(e, '-slide'),
			},
			origin: '0 0',
			w: function () {
			...
			updateHook: function () {
				var e = this;
				if (jn.zoomMode) {
					null == this.scrollbar && ((this.scrollbar = new Dn(this.el, 'slide')), (this.hscrollbar = new Dn(this.el, 'slide', true))),
				...
				} else this.scrollbar && (this.scrollbar.setEnabled(false), this.hscrollbar.setEnabled(false));
			},
		...
		return {
			...
			html: function () {
				((t = document.createElement('img')).onload = function () {
					(i = t.naturalWidth), (o = t.naturalHeight), (t.onload = null), r.updateChildren(true);
				}),
				...
				if ((this.collapsed && ('left' === this.pos ? (t -= o()) : (t += o())), this.animate && !this.animating)) {
					...
					var r = window.innerWidth,
						s = Vn.to(l, i, {
							x: t,
							onComplete: function () {
								(e.animating = false), (e.animate = false);
							},
							onUpdate: function () {
								'right' === e.pos && window.innerWidth != r && (s.kill(), (e.animating = false)), zn.trigger(Kn.frame.REFLOW), zn.trigger(Kn.frame.SCALE);
							},
						});
					this.animating = true;
				}
		...
		br = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					((G.model.sidebarOpts.closed && pr) || hr) && (fr(document.body, 'sidebar-closed'), (t.sidebar.collapsed = true)),
				...
				(n = [
					{
						...
						value: function (e) {
							e.keyCode !== lr.keys.ESCAPE || this.sidebar.collapsed || ('hamburger' === sr.lastFocusedElement().id ? this.onToggle() : this.onToggle(false));
						},
					},
					{
						key: 'getViewBox',
					...
					},
					{
						key: 'animateSidebar',
						value: function () {
							this.animate || ((this.sidebar.animate = true), this.sidebar.update());
						},
					},
					{
						key: 'onResize',
						value: function (e, t) {
							...
							!this.sidebar.collapsed && Xn(o) && (this.prevWidth > a || t)
								? ((this.sidebar.autoCollapsed = true), (this.sidebar.collapsed = true), this.setExpandedAttr().animateSidebar())
								: this.sidebar.autoCollapsed &&
								  !this.sidebar.floating &&
								  this.prevWidth < a &&
								  ((this.sidebar.collapsed = false), (this.sidebar.autoCollapsed = false), this.setExpandedAttr().animateSidebar()),
								(this.prevWidth = a);
						},
					},
					{
						...
						value: function () {
							...
							(this.sidebar.collapsed = !this.sidebar.collapsed),
								this.sidebar.collapsed || (this.sidebar.autoCollapsed = false),
								t
									? (this.onBlur(),
	...
	function Lr(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Pr(r.key), r);
		}
	}
	function Pr(e) {
		var t = (function (e, t) {
	...
	var Ar = DS,
		...
		Nr = {
			remaining: function (e, t) {
				return DS.utils.formatSecondsAsTime(t - e, true);
			},
			totalelapsed: function (e, t) {
				return [e, t]
					.map(function (e) {
						return DS.utils.formatSecondsAsTime(e, true);
					})
					.join(' / ');
			},
			elapsed: function (e) {
					...
					},
					{
						...
						value: function (e) {
							...
							document.body.classList[n]('timer-shown'),
								...
								this.view.parent.updateChildren(true);
						},
					},
					{
						key: 'onFocus',
	...
	function Qr(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, $r(r.key), r);
		}
	}
	function Gr(e, t) {
		return (
			...
			return (
				...
				(n = [
							...
							if (null != G.model && 0 !== this.view.children.length) {
								var n = (G.model.sidebarTabs || []).reduce(function (n, r) {
									var i = r.name,
										o = e[i],
										a = ''.concat(i, 'Tab');
									return (vi.isObject(o) ? true === o.enabled : true === o) && null != t.view.children[a] && n.push(t.view.children[a]), n;
								}, []);
								if (
									(this.view.children.forEach(function (e) {
										e.el.setAttribute('aria-selected', false), (e.el.tabIndex = -1);
									}),
								...
								if (null != this.currentTab) {
									this.currentTab.el.setAttribute('aria-selected', true);
					...
					},
					{
						key: 'onFocus',
						value: function (e) {
							this.isFocused || ((this.isFocused = true), this.getInitialActive().setCurrent(), Ci('keydown', this.onKeydown));
						},
					},
					{
						key: 'onBlur',
						value: function (e) {
							this.el.contains(e.relatedTarget) || ((this.isFocused = false), fi(yi(o.prototype), 'onBlur', this).call(this), xi('keydown', this.onKeydown));
						},
					},
					{
						key: 'onKeydown',
						...
						value: function () {
							null != this.activeTab &&
								(vi.forEach(this.view.children, function (e) {
									return e.el.setAttribute('aria-selected', false);
								}),
								this.activeTab.el.setAttribute('aria-selected', true),
					...
					},
					{
						...
						value: function () {
							return this.view.children.find(function (e) {
								return true === e.viewLogic.isActive;
							});
						},
					},
					{
			...
			return (
				...
				(n = [
					...
					},
					{
						key: 'hidePanel',
						value: function () {
							this.el.classList.remove('cs-selected'), this.el.setAttribute('aria-selected', 'false'), (this.isActive = false);
						},
					},
					{
						key: 'isLive',
	...
	function Mi(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Ui(r.key), r);
		}
	}
	function Hi() {
		return (
			...
			return (
				...
				(n = [
					...
					},
					{
						...
						value: function () {
							this.showSlider(),
								zi.to(this.tabSelectedSlider, 0.25, {
									x: this.view.x,
									width: this.view.w || 0,
					...
					},
					{
						...
						value: function (e) {
							'searchTab' !== this.view.nameKey
								? (Hi(Vi(o.prototype), 'showPanel', this).call(this, e), this.animateSlider(), (o.showingSearch = false))
								: (this.onToggleSearchInput(), (o.showingSearch = true));
						},
					},
					{
						key: 'isLive',
			...
			(G.def(oo, Pi, function (e) {
				...
				return {
					...
					updateHook: function () {
						...
						n && ((i.toLeft = true), (i.startPos = e)), this.flowChildren(i);
				...
				(n = [
					{
						key: 'teardown',
						value: function () {
							No.off(Fo.mobile.OUTLINE_SHOWN, this.onMobileOutlineShown), No.off(Fo.controlOptions.RESET, this.onControlOptionsReset, this), (Qo = false);
						},
					},
					{
						key: 'ensureEventSubscriptions',
						value: function () {
							Qo || (No.on(Fo.controlOptions.RESET, this.onControlOptionsReset, this), (Qo = true));
						},
					},
					{
		...
		da = (function (e) {
			...
			function o(e) {
				...
				!(function (e, t) {
					...
					G.model.outlineInSidebar || ((t.toggle = true), (t.searchInput.style.opacity = 1), (t.searchInput.style.display = 'block'));
				return (
						...
						value: function (e) {
							...
							(this.toggle = false),
								...
								oa.to(this.searchInput, 0.2, {
									...
									delay: 0,
									onComplete: function () {
										t.view.parent.children.outline.update(), ($i.showingSearch = false), (t.searchInput.style.display = 'none');
									},
								}),
							...
							xa.device.isMobile
								? (this.el.addEventListener('touchmove', function (t) {
								  ...
								  this.onClick(function (t) {
										e.moved || e.onClickItem(t), (e.moved = false);
								  }))
	...
	var $a = function (e) {
			...
			return (
				Ya(n, [
					...
					},
					{
						...
						value: function (e) {
							...
							if (this.el.contains(t)) {
								if (t === this.searchFilterEl || t === this.clearEl) return tl.setFocusRectOn(t), (this.isFocused = false), false;
								if (t === this.notesCheckEl || t === this.slideCheckEl) return tl.setFocusRectOn(t.parentElement), (this.isFocused = false), false;
						...
						value: function () {
							...
							(this.outlineUl = this.outlineUl || document.querySelector('#outline-content ul')),
								...
								nl.to(this.el, this.animationDuration, {
									alpha: 0,
									onComplete: function () {
										nl.to(e.outlineUl, e.animationDuration, {
											alpha: 1,
										}),
											e.view.setVisibility(false),
					...
					},
					{
						key: 'onAfterVisible',
						value: function () {
							this.view.parent.children.outline.setVisibility(false);
						},
					},
				]),
				n
		...
		Cl = G.def(El, Ol, function (e) {
			...
			return {
				attrs: {
					id: El + '-content',
					class: 'cs-menu cs-panel panel '.concat(n),
					tabindex: -1,
				},
				z: 2,
				x: 0,
	...
	var Rl,
			...
			return (
				...
				(n = [
					...
					},
					{
						...
						value: function (e, t) {
							var n = this;
							this.onClickLink(e, true),
								Yl(
									e,
									function (r) {
										r.classList.contains('item-collapsed') && (n.isCurrentLinkParent(e, t) || (es(r, 'item-collapsed'), r.setAttribute('aria-expanded', true)));
									},
									function (e) {
										return n.el === e;
									},
		...
		ds = G.def(cs, is, function () {
			...
			return {
				...
				attrs: {
					id: cs + '-content',
					class: 'is-scrollable cs-outline '.concat(as()),
					tabindex: -1,
					'aria-label': e.getString('outline-container'),
				},
				y: function () {
	...
	var ys = 'outlineSearch',
		bs = G.def(ys, jo, function () {
			...
			return {
				attrs: {
					id: ''.concat(ys, '-content'),
					class: 'outline-search '.concat(as()),
					tabindex: -1,
				},
				w: function () {
	...
	function ws(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Cs(r.key), r);
		}
	}
	function Ss(e, t) {
		return (
					...
					(n = [
						{
							...
							value: function (e) {
								...
								if (this.hasDefinition && null != t && 'p' !== t.nodeName.toLowerCase()) {
									...
									n &&
										(this.activeItem.firstElementChild.setAttribute('aria-expanded', false),
										(this.activeItem.style.backgroundColor = ''),
										this.closeItem(this.activeItem)),
										(n && this.lastSelected == t) || (t.setAttribute('aria-expanded', true), this.openItem(t.parentElement)),
										(this.lastSelected = t);
								}
							},
						},
	...
	var $s = DS.utils,
		...
		ic = G.def(tc, qs, function (e) {
			...
			return {
				attrs: {
					id: ''.concat(tc, '-content'),
					class: 'cs-resource '.concat(as(), ' resources'),
					tabindex: -1,
				},
				w: function () {
		...
		uc = G.def(cc, Rs, function () {
			...
			return (
				...
				{
					attrs: {
						id: ''.concat(cc, '-content'),
						class: ''.concat(as(), ' cs-glossary'),
						tabindex: -1,
					},
					w: '100%',
					h: function () {
			...
			function o(e) {
				...
				return (
					...
					mc.deviceView.isClassicMobile
						? kc.on(wc.mobile.NOTES_SHOWN, t.onHamburgerToggle.bind(yc(t), false))
						: mc.deviceView.isUnifiedMobile && kc.on(wc.hamburger.TOGGLE, t.onHamburgerToggle.bind(yc(t))),
					(t.forceScrollToTop = false),
					t
				);
			}
			return (
				...
				(n = [
					{
						...
						value: function (e) {
							this.forceScrollToTop && !e && ((this.getScrollElement().scrollTop = 0), (this.forceScrollToTop = false));
						},
					},
					{
						key: 'onFocus',
					...
					},
					{
						key: 'handleTab',
						value: function () {
							return this.el.parentElement.focus(), true;
						},
					},
					{
						key: 'onSlideChanged',
					...
					},
					{
						...
						value: function () {
							kc.off(wc.window.MAIN_CHANGED, this.onSlideChanged.bind(this)),
								...
								mc.deviceView.isClassicMobile
									? kc.off(wc.mobile.NOTES_SHOWN, this.onHamburgerToggle.bind(this, false))
				...
				(n = [
					{
						key: 'onShowTabItem',
						value: function (e) {
							this.hidePanel(), this.view.nameKey.includes(e) && this.showPanel(true);
						},
					},
					{
						key: 'onActiveTabSet',
					...
					},
					{
						key: 'onBlur',
						value: function (e) {
							(tu.presentation.isPreview() && !window.globals.HAS_SLIDE) ||
								this.onCheckShouldHide({
						...
						value: function () {
							...
							if (null != e)
								...
								(t = Pu(document.body, 'search-results-active')
									...
									this.view.panel.updateChildren(true);
							}
						},
					},
					{
						...
						value: function () {
							...
							vu.trigger(bu.tabLink.SHOW_PANEL, this),
								gu.deviceView.isPhone &&
									wu.from(this.view.panel.el, 0.12, {
										left: 'left' === G.model.sidebarOpts.sidebarPos ? 30 : -30,
									}),
			...
			r =
				...
				function (n, r, i, o) {
					...
					var f = de.getColor(n, '.cs-topmenu-item.active .cs-tab', 'border-top-color', '.cs-base'),
						d = {
							id: s,
							class: 'cs-topmenu-item cs-tabs top-tab '.concat(c),
							tabindex: 0,
						};
					u || ((d['aria-controls'] = ''.concat(i.name, '-panel')), (d['aria-expanded'] = false));
					var h = G.def(s, l, {
					...
					h.init(),
						G.getNamespace(Hu)[e.id].append(h, true),
						u ||
							(function (n, r, i, o) {
								var a = o.name + 'Panel',
									l = 'linksRight' === e.id,
			...
			phoneUpdateHook: function () {
				if (0 !== this.children.length || 0 !== Ku.length) {
					...
					this.children.forEach(function (e) {
						...
						null != e.panel && ((e.panel.inEllipsis = true), r.insertBefore(e.panel.el, r.firstChild), e.panel.update()),
							(e.inEllipsis = true),
			...
			if (DS.detection.deviceView.isPhone) this.phoneUpdateHook();
				...
				if (
					...
					var t = G.getNamespace(this.nameSpace),
						...
						a = this.w;
					if ((Bu > a && (Uu = true), (Bu = a), Uu && Gu(e) > this.w))
						for (; Gu(e) > this.w; ) {
							var l = Qu(this.children);
							if (null != l && l.isTopLink) {
								if (null != l.el) {
									var s = o.children.links.el;
									null != l.panel && ((l.panel.inEllipsis = true), s.insertBefore(l.panel.el, s.firstChild), l.panel.update()),
										(l.inEllipsis = true),
						...
						this.w > c + u.w &&
							...
							null != u.panel && ((u.panel.inEllipsis = false), u.panel.update(), this.el.appendChild(u.panel.el)),
							this.children.unshift(u),
							(u.inEllipsis = false));
					}
					0 === Ku.length && r.visible && r.setVisibility(false), (Uu = false);
					var f = {
						toLeft: true,
						startPos: n.w - xn,
						hook: function (e) {
					...
					'right' !== i.pos || G.model.rtl
						? G.model.rtl && ((f.toLeft = false), (f.startPos = 0), (f.reverse = false))
						: ((f.toLeft = false), (f.startPos = 0), (f.reverse = true)),
						this.flowChildren(f);
				}
			}
		},
	...
	function df(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, gf(r.key), r);
		}
	}
	function hf() {
		return (
					...
					},
					{
						...
						value: function (e) {
							...
							setTimeout(function () {
								...
								t.el.contains(e) ||
									'tooltip' === e.id ||
									((t.isOpen = false), _f(t.el, 'open'), t.view.el.removeEventListener('mouseleave', t.onHide), Af('keydown', t.onKeydown), t.view.update());
							}, 200);
						},
					},
					{
	...
	function Uf(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Zf(r.key), r);
		}
	}
	function Kf(e, t) {
		return (
	...
	G.def(Hf, Mf, function (e) {
		...
		return {
			...
			y: function () {
				return (this.el.style.top = Ff(this.viewLogic.isOpen ? -58 : 17, false)), 0;
			},
			html: function () {
				return (
		...
		od = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					(t.toggle = false),
					Yf.on(ed, function (e) {
						return t.onVisibilityChanged(true);
					}),
					Yf.on(td, function (e) {
						return t.onVisibilityChanged(false);
					}),
			...
			return (
				...
				(n = [
					...
					},
					{
						...
						value: function (e) {
							this.view.setVisibility(e, true), this.view.childVisibilityChanged(), (this.toggle = Xf.isCaptionEnabled()), this.updateBtn();
						},
					},
					{
	...
	function cd(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, yd(r.key), r);
		}
	}
	function ud(e, t) {
		return (
		...
		Ed = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					pd(dd((t = i.call(this, e))), 'hasTooltip', true),
	...
	function Td(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Rd(r.key), r);
		}
	}
	function _d(e, t) {
		return (
	...
	G.def(Ld, Cd, function () {
		return {
			...
			attrs: {
				...
				'aria-pressed': false,
				'aria-label': xd.getString('acc_pause'),
				tabindex: 0,
			},
			contentStyle: {
				width: '34px',
		...
		qd = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					Id(Dd((t = i.call(this, e))), 'hasTooltip', true),
					Id(Dd(t), 'tooltipMoves', true),
			...
			return (
				...
				(n = [
					...
					},
					{
						key: 'isSeekable',
						value: function () {
							if (null == this.currSlide) return false;
					...
					},
					{
						...
						value: function () {
							this.isSeekable()
								? (Kd(this.el, 'read-only'), (this.progressBarEl.disabled = false))
								: (Ud(this.el, 'read-only'), (this.progressBarEl.disabled = true));
						},
					},
					{
						key: 'onTick',
					...
					},
					{
						...
						value: function (e) {
							...
							null != n && this.currTimeline.progress(this.getSeekValue(n)), (this.isUp = false);
						},
					},
					{
						key: 'seekBy',
					...
					},
					{
						key: 'onMouseUp',
						value: function (e) {
							this.onSeek(e), this.removeEndListener(), this.removeSeekListener(), (this.isUp = true), this.currTimeline.onSeekEnd();
						},
					},
					{
						key: 'onKeydown',
	...
	function ph(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, wh(r.key), r);
		}
	}
	function yh(e, t) {
		return (
	...
	G.def(dh, fh, function (e) {
		...
		return {
			attrs: {
				id: dh,
				tabindex: -1,
				class: 'progress-bar cs-seekcontrol '.concat(r ? 'read-only' : ''),
			},
			y: 'vertical-center',
			overflow: 'visible',
			noUpdate: true,
		...
		Ch = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					mh(vh((t = i.call(this, e))), 'hasTooltip', true),
	...
	G.def(Lh, xh, function () {
		return {
			...
			attrs: {
				id: Lh,
				class: 'content-center cs-button',
				'aria-label': ''.concat(G.model.getString('acc_replay')),
				tabindex: 0,
			},
			style: {
				background: 'transparent',
	...
	function Ah(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Hh(r.key), r);
		}
	}
	function Ih(e, t) {
		return (
		...
		Xh = function (e, t) {
			G.def(e, Qh, function (n) {
				...
				return {
					...
					attrs: {
						id: e,
						class: 'cs-button btn '.concat(i ? 'lightboxed' : ''),
						'aria-label': r.getString(qh[e]),
						tabindex: 0,
					},
					parentAlign: function () {
						return i ? 'r' : Gh ? 'br' : 'r';
	...
	function Jh(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, ip(r.key), r);
		}
	}
	function ep(e, t) {
		return (
	...
	Xh('prev', true), Xh('next', false), Xh('submit', false);
	var op = DS,
	...
	G.def('sidebarOverlay', Dt, function () {
		return {
			...
			attrs: {
				...
				'aria-label': G.model.getString('close'),
				tabIndex: -1,
			},
			x: 0,
			y: 0,
		...
		Dp = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					Pp(t.hideEvent, t.onCheckShouldHide, true),
			...
			return (
				...
				(n = [
					...
					},
					{
						key: 'showPanel',
						value: function () {
							this.topEllipsisPanel.setVisibility(true),
								(this.hideOnNextTouch = true),
					...
					},
					{
						...
						value: function () {
							Op.trigger(Ep.topEllipsesPanel.HIDE_PANEL, this),
								...
								this.topEllipsisPanel.setVisibility(false),
								(this.hideOnNextTouch = false),
								(this.topEllipsisPanel.yOff = -20),
								this.updateAnimation(),
								null != this.currentPanelLink && (this.currentPanelLink.hidePanel(true), (this.currentPanelLink = null));
						},
					},
					{
						key: 'onResize',
	...
	function Fp(e) {
		for (var t = 1; t < arguments.length; t++) {
			...
			t % 2
				? Np(Object(n), true).forEach(function (t) {
						Wp(e, t, n[t]);
				  })
	...
	function zp(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Yp(r.key), r);
		}
	}
	function Qp(e, t) {
		return (
	...
	function oy(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, dy(r.key), r);
		}
	}
	function ay() {
		return (
	...
	G.def('captionContainer', Jp, function (e) {
		...
		return {
			...
			style: {
				fontSize: ''.concat(null != s ? s.size : l || a, '%'),
			},
			z: 2,
			methods: {
				beforeUpdateHook: function () {
		...
		xy = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					fy(cy((t = i.call(this, e))), 'hasTooltip', true),
					fy(cy(t), 'tooltipKey', 'acc_settings'),
					fy(cy(t), 'hideTooltipWhenOpen', true),
				...
				(n = [
					...
					},
					{
						...
						value: function () {
							...
							(this.isOpen = true),
								...
								this.settingsBtnEl.setAttribute('aria-expanded', true),
								null != this.view.updatePanelDepth && this.view.updatePanelDepth(true),
					...
					},
					{
						...
						value: function () {
							(this.isOpen = false),
								by(this.el, 'open'),
								this.settingsBtnEl.setAttribute('aria-expanded', false),
								null != this.view.updatePanelDepth && this.view.updatePanelDepth(false),
					...
					},
					{
						...
						value: function (e) {
							var t = e.target;
							if (this.el.contains(t)) return Sy.setFocusRectOn(t), this.onHoverIn(e), (this.isFocused = false), false;
						},
					},
				]) && oy(t.prototype, n),
				r && oy(t, r),
	...
	function By(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, Uy(r.key), r);
		}
	}
	function My() {
		return (
		...
		$y = (function (e) {
			...
			function o(e) {
				...
				return (
					...
					Vy(Fy((t = i.call(this, e))), 'hasTooltip', true),
					Vy(Fy(t), 'tooltipKey', 'acc_playback_speed'),
					Vy(Fy(t), 'hideTooltipWhenOpen', true),
					(t.currentSpeed = 1),
					(t.currentIndex = 4),
			...
			return (
				...
				(n = [
					...
					},
					{
						...
						value: function (e) {
							this.selectedEl.classList.remove('selected'),
								...
								this.selectedEl.setAttribute('aria-checked', false),
					...
					},
					{
						...
						value: function (e) {
							var t = e.target;
							if (this.el.contains(t)) return qy.setFocusRectOn(t), this.onHoverIn(e), (this.isFocused = false), false;
						},
					},
				]) && By(t.prototype, n),
				r && By(t, r),
	...
	function ab(e, t) {
		for (var n = 0; n < t.length; n++) {
			var r = t[n];
			(r.enumerable = r.enumerable || false), (r.configurable = true), 'value' in r && (r.writable = true), Object.defineProperty(e, hb(r.key), r);
		}
	}
	function lb() {
		return (
		...
		kb = (function (e) {
			...
			function o(e) {
				...
				!(function (e, t) {
					...
					db(ub((t = i.call(this, e))), 'hideTooltipWhenOpen', true),
					db(ub(t), 'hasTooltip', true),
			...
			return (
				...
				(n = [
					...
					},
					{
						...
						value: function (e) {
							var t = e.target;
							if (this.el.contains(t)) return gb.setFocusRectOn(t), (this.isFocused = false), false;
						},
					},
				]) && ab(t.prototype, n),
				r && ab(t, r),
	...
	G.def(Vb, Fb, function (e) {
		...
		return {
			attrs: {
				id: Vb,
				class: 'cs-base cs-'.concat(t.frame.default_layout, ' fn-').concat(t.frame.default_layout),
			},
			style: {
	...
	G.def(zb, Cn, function (e) {
		...
		return (
			Kb(
				(t = {
					attrs: {
						class: ''.concat(zb, ' window-slide ').concat(e, '-slide'),
						role: 'dialog',
						'aria-modal': true,
					},
					overflow: 'scroll',
			...
			Kb(t, 'updateHook', function () {
				var e = this;
				if (Gb.zoomMode) {
					null == this.scrollbar && ((this.scrollbar = new Zb(this.el, 'lightbox-slide')), (this.hscrollbar = new Zb(this.el, 'lightbox-slide', true))),
	...
	G.def(gv, Cn, function (e) {
		...
		return {
			attrs: {
				id: gv,
				class: 'cs-window window-slide '.concat(e, '-slide'),
				tabindex: -1,
			},
			style: {
				overflow: 'visible',
	...
	G.def(wv, function (e) {
		var t = G.model,
			n = t.preso.display().windows().find({
				id: e,
			}),
	...
	!(function (e, t) {
		...
		(Jv((Yv = {}), _b, function (e) {
			...
			(t = document.querySelectorAll('.panel > div[id*=content]')),
				...
				Array.from(t).forEach(function (e) {
					...
					if ('outline-panel' != t) {
						...
						null != i && new nt(i, 'outline', false, n), null != o && new nt(o, 'search', false, n);
					}
				});
			var y = function (e) {
					return function (t) {
			...
			var O = function () {
				...
				e && null != e.children && e.updateChildren(true);
			};
			...
			return (
				DS.pubSub.on(DS.events.frameModel.CHROMELESS_CHANGED, E),
				{
					...
					rerender: function () {
						G.update(p, true),
							G.nameSpaces[_b].wrapper.updateChildren(true),
		...
		Jv(Yv, mv, function (e) {
			G.tree(mv, [
				{
					printWrapper: ['printSlide'],
				},
			]);
			var t = G.getNamespace(mv);
			return (
				(t.slide = t.printSlide),
				(t.wrapper = t.printWrapper),
				{
					all: function () {},
					resize: function () {},
					pinchZoom: function () {},
